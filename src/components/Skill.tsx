...
return(
    ...
    <div onClick={onClick} className={` cursor-pointer rounded-[50px] ${currentSkill == skill.id ? "bg-bgDark dark:bg-white" :"bg-bgLight dark:bg-bgDark hover:dark:bg-[#ffffff91] hover:bg-[#000000d2]" } transition-all ease-in-out duration-200 border-2 border-bgDark dark:border-white md:border-0 group flex px-3 md:px-[12px] pt-[10px] md:pt-[4px] pb-[8px] md:pb-[2px] justify-center items-center `}> 
