...
export default function AboutSection() {
  return (
    <section id="About" className=" md:px-20 px-4 z-0 w-full md:min-h-200 bg-bgDark md:gap-0 gap-12 flex flex-col items-center justify-between pt-20 pb-0 md:pb-10">





      <h1 className=" font-ncs text-[48px] md:text-[90px] text-white ">About me</h1>


    

      <div className=" w-full md:gap-0 flex flex-col gap-6 min-h-170 md:grid md:grid-cols-20 md:grid-rows-17">


    <div className=" md:col-start-15 md:col-end-21 md:row-start-1 md:row-end-12 flex items-center justify-center">
       <img
            src={myImg}
            alt="My Photo"
        ...
        <div className="   md:row-start-11 relative md:col-start-1 flex flex-col items-start md:col-span-full md:row-span-full mt-6 z-10 gap-5">
          ...
          <p className=" font-ncs md:text-lg text-sm text-white ">
